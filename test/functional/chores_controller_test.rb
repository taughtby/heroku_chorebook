...
class ChoresControllerTest < ActionController::TestCase
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post :create, chore: { child_id: @chore.child_id, completed: @chore.completed, due_date: @chore.due_date, name: @chore.name, points: @chore.points }
    end
  ...
  test "should update chore" do
    put :update, id: @chore, chore: { child_id: @chore.child_id, completed: @chore.completed, due_date: @chore.due_date, name: @chore.name, points: @chore.points }
    assert_redirected_to chore_path(assigns(:chore))
  end
